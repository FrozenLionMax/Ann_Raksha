...
const donationSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: ["available", "matched", "picked_up", "completed"], default: "available" },
    claimedBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", default: null },
    matchMode: { type: String, enum: ["automatic", "manual"], default: "automatic" },
    matchedNgos: [{ ngoId: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, score: Number, reason: String }],
